"""Detecting readability barriers.

Detection only: nothing here rewrites text. Each detector reports what it
found and, where a safe alternative exists, what could replace it — the
decision to actually apply anything belongs to the caller.
"""
...
def find_long_sentences(sentences: list[str]) -> list[Barrier]:
    ...
    """
    from .tokenize import split_words as sw
