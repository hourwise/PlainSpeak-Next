"""
Grammar-aware post-processing for mechanical text simplification.

After word-level glossary substitutions, this module applies
lightweight fixes to common grammar issues introduced by the
substitution process. All fixes are heuristic — they reduce
but do not eliminate the need for human review.
"""
