...
LEGACY, UNGUARDED. The "Simplified Text" this serves comes from the inherited
substitution engine (`core.transform`), not the governed pipeline: no integrity
firewall, no profiles, no review. It will be moved onto the pipeline or
withdrawn before 1.0.
  ...
  <div class="results" id="results" aria-label="Analysis results">
    ...
    <div class="tab-panel active" id="panel-simplified" role="tabpanel">
      <div class="warning-note">
        <strong>⚠ Legacy, unguarded.</strong> Simplified text is mechanically generated by word substitution,
        without PlainSpeak's integrity firewall: it can change meaning, including numbers, obligations and negations.
        Changed words are <mark>highlighted</mark>. Always review before using — substitutions may not fit the context.
        For governed, integrity-checked review use the PlainSpeak desktop application.
      </div>
