...
Produces a self-contained, accessible HTML report from readability
analysis and simplification results. The report itself is designed
to meet WCAG 2.1 AA standards.

The output is a single .html file with embedded CSS — no external
resources, no JavaScript required.

Also supports JSON output for machine readability and integration
with other tools.
"""
...
from .analyzer import ReadabilityScores, describe_flesch_score
from .simplifier import SimplificationResult, Barrier
